...
<head>
    ...
    <title>Thanusha Portfolio</title>
...
<nav>
    ...
    <div class="nav-links">
        ...
        <a href="THANUSHA S.pdf" class="hire-btn" download>Download CV</a>
    </div>
</nav>

<header class="hero">
    <div class="profile-side">
        <img src="me2.jpeg" alt="Thanusha" class="profile-img">
    </div>
    <div class="text-side">
        <h1>Excited for learning <br><span id="typing-text"></span></h1>
        <p>I am dedicated student passionate about building functional and  digital solutions.you should hire me because i blend technical logic with creative problem solving and am always ready to adapt to new technologies.</p>
    </div>
</header>

<section id="about">
    <div class="v-box edu-card">
        <img src="download (1).jpeg" alt="BCU" class="univ-logo">
        <div>
            <h2 style="color: var(--primary);"><b>Education</b></h2>
            <p><b>Currently studying in Bengaluru City University</b></p>
        </div>
    </div>
</section>
...
<section id="projects">
    ...
    <div class="grid">
        <div class="v-box"><h3>Studywiththanu</h3><p>build for uploading a notes ,model paper ,textbooks <br> specially for SEP students</p></div>
    ...
    <div style="display: flex; gap: 50px; align-items: center; flex-wrap: wrap;">
        ...
        <div style="flex: 1; min-width: 300px;">
            ...
            <div class="social-container">
                ...
                <a href="https://github.com/thanusha-20" class="social-item" target="_blank">
                    <img src="github.jpeg" class="social-icon" alt="GitHub">
                    <span>GitHub Profile</span>
                </a>

                <a href="https://www.linkedin.com/in/thanusha-s-765555361" class="social-item" target="_blank">
                    <img src="linkedin.jpeg" class="social-icon" alt="LinkedIn">
                    <span>LinkedIn Profile</span>
                </a>

                <a href="mailto:sthanusha60@gmail.com" class="social-item">
...
<footer>
    ...
    <p>Connect me on 
        <a href="https://github.com/thanusha-20" style="color: var(--primary); text-decoration: none;">GitHub</a> 
        and 
        <a href="https://www.linkedin.com/in/thanusha-s-765555361" style="color: var(--primary); text-decoration: none;">LinkedIn</a>
    </p>
